...
@section('content')
    <section class="employer-signup-new login cb-section">
        <div class="container">
            <div class="row row-sp">
                ...
                <div class="col-xl-7">
                    <div class="box-info-signup forgot-password-success register-success">
                        <div class="title">
                            <h2>Chúc mừng bạn đã đăng kí thành công !</h2>
                        </div>
                        <div class="main-form">
                            <div class="user-action" style="text-align: left;">
                                <p>Vui lòng <a href="https://mail.google.com/mail/u/0/#inbox">kiểm tra email </a> của bạn để kích hoạt tài khoản </p>
                                <p>
                                    “Nếu bạn sử dụng Gmail hoặc công ty bạn đang sử dụng dịch vụ email của Google để đăng ký tài khoản, bạn nên kiểm tra email trong các mục Inbox/Hộp thư đến (Primary, Social, Promotions) và Spam. Hoặc dùng công cụ tìm kiếm email để tìm tên email: support@everywork.vn.”
                                    <span class="noti" style="position: relative;"><em class="material-icons" style="color: #000000">error</em>
												<span class="toolip">
													<span>
										            	Đối với Gmail: Mẹo để email của bạn luôn vào Hộp thư đến/Inbox:<br><br>
Cách 1: Nắm kéo thả email từ các mục Promotions, Social, Spam về mục Primary hoặc nhấp chuột phải vào mail và chọn “Move to tab”.<br><br>
Cách 2: Vào Configure của Gmail (biểu tượng bánh xe góc trên bên phải), chọn Configure Inbox và bỏ dấu chọn ở các mục Promotions, Social. Sau đó Lưu lại.
													</span>
												</span>
											</span>
                                </p>
                                <div class="text-help">
                                    ...
                                    <p>Email:<a href="mailto:support@everywork.vn" target="_blank">support@everywork.vn</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
