                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                ...
                                                @if(isset($benefitChecked['chedobaohiem']) && $benefitChecked['chedobaohiem'] == 1)
                                                    checked
                                                @endif
                                                       value="1">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                ...
                                                @if(isset($benefitChecked['dulich']) && $benefitChecked['dulich'] == 1)
               checked
           @endif
                                                       value="1">
                                                <label for="BENEFIT_ID_2"> <em
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                ...
                                                @if(isset($benefitChecked['chedothuong']) && $benefitChecked['chedothuong'] == 1)
               checked
           @endif value="1">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['chamsocsuckhoe']) && $benefitChecked['chamsocsuckhoe'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['daotao']) && $benefitChecked['daotao'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['tangluong']) && $benefitChecked['tangluong'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['laptop']) && $benefitChecked['laptop'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['phucap']) && $benefitChecked['phucap'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['xeduadon']) && $benefitChecked['xeduadon'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['dulichnuocngoai']) && $benefitChecked['dulichnuocngoai'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['dongphuc']) && $benefitChecked['dongphuc'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['congtacphi']) && $benefitChecked['congtacphi'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['phucapthamnien']) && $benefitChecked['phucapthamnien'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['nghiphepnam']) && $benefitChecked['nghiphepnam'] == 1)
               checked
           @endif
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group form-checkbox">
                                                <input
                                                @if(isset($benefitChecked['clbthethao']) && $benefitChecked['clbthethao'] == 1)
               checked
           @endif
                                    ...
                                    <div class="main-image">
                                        ...
                                        <div class="list-image" id="list-image">
                                            <div class="image-item">
                                                <img id="banner"
                                                     src="{{ asset('banner_job/'. $job -> img_banner) }}"
                                                     alt="Banner">
                                            </div>
                                        </div>
