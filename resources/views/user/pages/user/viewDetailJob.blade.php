            ...
            <div class="job-detail-bottom-wrapper">
                <div class="apply-now-content">
                    ...
                    <div class="job-desc">
                        ...
                        @endif "
                           data-id="{{ $job -> idJob }}"
                           onclick="savejob1({{$job -> idJob}})">
                            <i class="mdi mdi-heart-outline"></i>
                            <span class="text">Lưu việc làm</span>
                        </a>
                        <a tabindex="0" role="button" onclick="showboxJobalert()"><i
                            ...
                            <div class="modal-body">
                                <form name="feedback_job" id="feedback_job" method="POST" autocomplete="off">
                                    ...
                                    <div class="form-group" style="clear:left">
                                        <button class="btn-send-report" onclick="saveFeedbackJob();return false;"> Báo
                                            xấu
                                        </button>
                                    </div>
                                </form>
